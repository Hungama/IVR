 ...
 */
public class CRBT_unavailable_log extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/crbt_unavailable/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				outp = new FileOutputStream("/home/Hungama_call_logs/crbt_unavailable/no_crbt_"+strlogfile+".txt", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/crbt_unavailable/no_crbt_"+strlogfile+".txt", true);
