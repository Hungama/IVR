 ...
 */
public class Consent_log extends HttpServlet {
	...
	public static String dsn="Airtel_IVR";
	public static String username="ivr";
	public static String pwd="IVR@airtel";
	...
	public void init()
	{
		try
		{
			...
			con = DriverManager.getConnection("jdbc:mysql://10.2.73.160:3306/"+ dsn, username, pwd);
			if(con!=null)
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			temp1 = "#"+service+"#" +ANI + "#" + circle + "#" + starttime + "#" + dnis + "#" + realdnis + "#"+consent+"#"+response_code+"#"+strlogfile+"#"+sessonid;

			FileOutputStream outp = null; // declare a file output object
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/ConsentLog/"+service+"/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				strlogfile = service+"_consentlog_"+strlogfile;
				outp = new FileOutputStream("/home/Hungama_call_logs/ConsentLog/"+service+"/" +strlogfile+".txt", true);
			}
			else
			{
				strlogfile = service+"_consentlog_"+strlogfile;
			...
			synchronized(this)
			{
				try
				{
					...
					stmtupdate.executeUpdate("insert into Airtel_IVR.tbl_consent_log(ANI,circle,starttime,service,SC,consent,response,date_time,sessonid)values('"+ANI+"','"+circle+"','"+starttime+"','"+service+"','"+realdnis+"','"+consent+"','"+response_code+"',now(),'"+sessonid+"')");
