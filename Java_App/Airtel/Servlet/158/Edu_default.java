 ...
 */
public class Edu_default extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String sp_file=null;
		String clip = (String) request.getParameter("clip");
		String path = (String) request.getParameter("path");
		//out.println("path is "+path);
		//out.println("clip is "+clip);
		...
		try {
			    //File file_txt1 = new File("e:/EDUconfig/"+path+".txt");
				File file_txt1 = new File("/var/lib/apache-tomcat-6.0.32/webapps/hungama/config/EDUconfig/"+path+".txt");
				...
				key = clip;
				//out.println("key is: "+hashMap.get(key));
				if(hashMap.get(key)!=null)
				{
					favSongs1=hashMap.get(key);
					String temp1[] = favSongs1.split(":");
					favSongs1= temp1[1];
					favSongs1 = "ques.value='" + favSongs1 + "'";
					//out.println("ques.value=");
