			...
			if(TOKEN.equalsIgnoreCase("CRBT_SET"))
			{
				...
				if(zone.equalsIgnoreCase("south"))
					if(circle.equalsIgnoreCase("19"))
						ulink="http://10.89.8.73:8080/rbt/rbt_promotion.jspMSISDN="+ANI+"&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_"+vcode+"_rbt&SELECTED_BY=HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=FREEREN&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
						...
						ulink="http://10.111.15.46:8080/rbt/rbt_promotion.jspMSISDN="+ANI+"&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_"+vcode+"_rbt&SELECTED_BY=HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=FREEREN&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
					...
					//	ulink="http://10.111.15.46:8080/rbt/rbt_promotion.jsp?MSISDN="+ANI+"&REQUEST=SELECTION&SUB_TYPE=Prepaid&CATEGORY_ID=27&WAV_FILE=rbt_"+vcode+"_rbt&SELECTED_BY=HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
						...
						ulink="http://10.127.7.4:8080/rbt/rbt_promotion.jspMSISDN="+ANI+"&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_"+vcode+"_rbt&SELECTED_BY=HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=FREEREN&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
					else
						ulink="http://10.89.8.73:8080/rbt/rbt_promotion.jspMSISDN="+ANI+"&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_"+vcode+"_rbt&SELECTED_BY=HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=FREEREN&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
				else if(zone.equalsIgnoreCase("north"))
					ulink ="http://10.2.89.202/URLIntegration/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=HUN_IVR&pass=hun_ivr&flag=0&sFree=1&dFree=0";
				else if(zone.equalsIgnoreCase("east"))
					ulink = "http://10.133.23.190/URLIntegration/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=HUN_IVR&pass=hun_ivr&flag=0&sFree=1&dFree=0";
				else if(zone.equalsIgnoreCase("west"))
					ulink = "http://10.49.5.90/URLIntegration/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=HUN_IVR&pass=hun_ivr&flag=0&sFree=1&dFree=0";
