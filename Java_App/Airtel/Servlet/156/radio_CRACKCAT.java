 ...
 */
public class radio_CRACKCAT extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try
		{
					...
					if(Token.equalsIgnoreCase("USERSTATUS"))
						ulink ="http://10.5.10.200/airtel/airtel_crack_cat/ivr_check_status.php?msisdn="+ANI;
					else if(Token.equalsIgnoreCase("ACTIVATE"))
						ulink ="http://10.5.10.200/airtel/airtel_crack_cat/sms_hit_url_from_airtel.php?msisdn="+ANI+"&sub_type=IVR&sub_days="+SUBDAY;
