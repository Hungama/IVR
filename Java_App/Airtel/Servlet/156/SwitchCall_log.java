...
public class SwitchCall_log extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			temp1 = "#"+service+"#" +ANI + "#" + circle + "#" + starttime + "#" + dnis + "#" + realdnis + "#";

			FileOutputStream outp = null; // declare a file output object
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/Switch/"+service+"/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				strlogfile = service+"_switchlog_"+strlogfile;
				outp = new FileOutputStream("/home/Hungama_call_logs/Switch/"+service+"/" +strlogfile+".txt", true);
			}
			else
			{
				strlogfile = service+"_switchlog_"+strlogfile;
