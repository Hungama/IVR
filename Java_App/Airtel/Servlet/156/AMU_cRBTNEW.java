 ...
 */
public class AMU_cRBTNEW extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		System.out.println("SNGID==="+SNGID);
		System.out.println("cirname==="+cirname);
		System.out.println("HTflag==="+HTflag);
		...
		try
		{
			...
			if(zone.equalsIgnoreCase("south"))
					if(circle.equalsIgnoreCase("19")) //KK
						...
						if(req.equalsIgnoreCase("new")) 
						{
							ulink="http://10.89.8.73:8080/rbt/Selection.do?action=SET&subscriberID=" + ANI + "&callerID=ALL&categoryID=6&clipID=rbt_" + vcode + "_rbt&isPrepaid=y&mode=IVR_HUNGAMA&calledNo=543211&subscriptionClass=PACK30&chargeClass=DEFAULT_R15";
						}
						else
						{
						...
						if(req.equalsIgnoreCase("new")) 
						{
							ulink="http://10.105.55.36:8080/rbt/Selection.do?action=SET&subscriberID=" + ANI + "&callerID=ALL&categoryID=6&clipID=rbt_" + vcode + "_rbt&isPrepaid=y&mode=IVR_HUNGAMA&calledNo=543211&subscriptionClass=PACK30&chargeClass=DEFAULT_R15";
						}
						else
						{
							ulink="http://10.105.55.36:8080/rbt/rbt_promotion.jsp?MSISDN=" + ANI + "&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_" + vcode + "_rbt&SELECTED_BY=IVR_HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=DEFAULT_R15&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
						}		 
						
					else if(circle.equalsIgnoreCase("23")) //TN
						if(req.equalsIgnoreCase("new")) 
						{
							ulink="http://10.111.15.46:8080/rbt/Selection.do?action=SET&subscriberID=" + ANI + "&callerID=ALL&categoryID=6&clipID=rbt_" + vcode + "_rbt&isPrepaid=y&mode=IVR_HUNGAMA&calledNo=543211&subscriptionClass=PACK30&chargeClass=DEFAULT_R15";
						}
						else
						{
							ulink="http://10.111.15.46:8080/rbt/rbt_promotion.jsp?MSISDN=" + ANI + "&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_" + vcode + "_rbt&SELECTED_BY=IVR_HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=DEFAULT_R15&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
						}

 					else if(circle.equalsIgnoreCase("22")) //KL

						if(req.equalsIgnoreCase("new")) 
						{
							ulink="http://10.127.7.4:8080/rbt/Selection.do?action=SET&subscriberID=" + ANI + "&callerID=ALL&categoryID=6&clipID=rbt_" + vcode + "_rbt&isPrepaid=y&mode=IVR_HUNGAMA&calledNo=543211&subscriptionClass=PACK30&chargeClass=DEFAULT_R15";
						}
						else
						{
							ulink="http://10.127.7.4:8080/rbt/rbt_promotion.jsp?MSISDN=" + ANI + "&REQUEST=SELECTION&SUB_TYPE=Prepaid&WAV_FILE=rbt_" + vcode + "_rbt&SELECTED_BY=IVR_HUNGAMA&ISACTIVATE=TRUE&SUBSCRIPTION_CLASS=DEFAULT35&CHARGE_CLASS=DEFAULT_R15&REDIRECT_NATIONAL=TRUE&ISACTIVATE=True";
			...
			/*Reeju Change*/	ulink ="http://10.2.96.114:9080/CWM/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=Hun_IVR&pass=SHVuX0lWUg==&flag=0&sFree=1&dFree=1";
			...
			/*Reeju Change*/   	ulink = " http://10.133.27.101:9080/CWM/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=Hun_IVR&pass=SHVuX0lWUg==&flag=0&sFree=1&dFree=1";
						...
						if(circle.equalsIgnoreCase("9") || circle.equalsIgnoreCase("9")) //MP and GJ
							{
				/*Reeju Change*/     	ulink = "http://10.49.7.86:9080/CWM/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=Hun_IVR&pass=SHVuX0lWUg==&flag="+HTflag+"&sFree=1&dFree=1";
							}							
						else
							{
				/*Reeju Change*/	ulink = "http://10.49.7.86:9080/CWM/helloTune.jsp?msisdn="+ANI+"&vcode="+vcode+"&uid=Hun_IVR&pass=SHVuX0lWUg==&flag=0&sFree=1&dFree=1";
					...
					System.out.println("crbt url===" +ulink);
