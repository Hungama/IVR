...
/*     */
/*     */ public class tataTisconDetails extends HttpServlet
/*     */ {
...
/*     */
/*  49 */       ds = (DataSource)envCtx.lookup("jdbc/Hungama_Tatasky");
/*     */     } catch (Exception e) {
...
/*  79 */       if (conat1 != null)
/*     */       {
/*  81 */         ccstmt1 = conat1.prepareCall("{call TATA_MISSSEDCALL_UPDATE(?,?,?)}");
/*  83 */
...
/*     */     }
/*     */
/* 118 */     String PROCEDURE = "TATA_MISSSEDCALL_UPDATE";
/* 119 */
/* 125 */     String Inparameter_string = "3";
