...
/*     */
/*     */ public class mcDowellsdetails extends HttpServlet
/*     */ {
...
System.out.println("TATATISCONNNNNNNNNN-->");
/*  45 */       Context initCtx = new InitialContext();
/*  46 */       Context envCtx = (Context)initCtx.lookup("java:comp/env");
/*     */
/*  49 */       ds = (DataSource)envCtx.lookup("jdbc/Hungama_ENT_MCDOWELL");
/*     */     } catch (Exception e) {
...
/*  79 */       if (conat1 != null)
/*     */       {
/*  81 */         ccstmt1 = conat1.prepareCall("{call MCDOWELL_MISSEDCALL_DETAILS(?,?,?,?)}");
/*  83 */
/*  87 */         ccstmt1.setString(1, ANI);
/*  88 */         ccstmt1.setString(2, IN_CALLID);
		    ccstmt1.setString(3, IN_SESSIONID);
		    ccstmt1.setString(4, IN_CHANNEL);
/*  89 */
/*  90 */         ccstmt1.execute();
/*  91 */         conat1.close();
/*  92 */         ccstmt1.close();
...
/*     */     }
/*     */
/* 118 */     String PROCEDURE = "MCDOWELL_MISSEDCALL_DETAILS";
/* 119 */
/* 125 */     String Inparameter_string = "4";
