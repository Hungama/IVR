...
/*     */
/*     */ public class maxBupadetails extends HttpServlet
/*     */ {
...
/*     */
/*  49 */       ds = (DataSource)envCtx.lookup("jdbc/hul_hungama");
/*     */     } catch (Exception e) {
...
/*  79 */       if (conat1 != null)
/*     */       {
/*  81 */         ccstmt1 = conat1.prepareCall("{call MAX_BUPA_DETAILS(?,?,?)}");
/*  83 */
...
/*     */     }
/*     */
/* 118 */     String PROCEDURE = "MAX_BUPA_DETAILS";
/* 119 */
