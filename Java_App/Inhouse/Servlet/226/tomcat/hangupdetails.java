...
public class hangupdetails extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/hangup_logs/");
			File hangupfile = new File("/home/Hungama_call_logs/hangup_logs/hangup_logs_"+strlogfile+".txt");
			if(!hangupfile.exists())
			{
				bExist=false;
			}
			if (!ServiceFolder.exists())
			{
				...
				outp = new FileOutputStream("/home/Hungama_call_logs/hangup_logs/hangup_logs_"+strlogfile+".txt", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/hangup_logs/hangup_logs_"+strlogfile+".txt", true);
			...
			DATA = "#"+timestamp+"#"+ANI+"#"+DNIS+"#"+CODE+"#"+DCEND+"#"+evt+"#";
			synchronized(this)
			{
				try
				{
					...
					if(!bExist)
					{
						p1.println("#TIME_STAMP#ANI#DNIS#CAUSE_CODE#DISCONNECT_END#EVENT_DESCRIPRTION#");
					}
					p1.println(DATA);
					p1.flush();
					p1.close();
