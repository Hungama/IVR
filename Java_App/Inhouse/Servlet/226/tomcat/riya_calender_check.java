 ...
 */
public class riya_calender_check extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
				...
				if(type.equals("sub"))
					...
					sp_file=type+"_welcome";

			    File file_txt1 = new File(getServletContext().getRealPath("config/ManchalaConfigRiya/songconfignewsub/WelcomeCalender/"+sp_file+".cfg"));
				...
				if(file_txt1.exists())
				{
					...
					System.out.println("favSongs is: "+favSongs);
