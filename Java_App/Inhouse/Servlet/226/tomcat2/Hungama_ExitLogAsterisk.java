...
public class Hungama_ExitLogAsterisk extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		System.out.println("Exit Log Call");
		...
		contentlog =contentlog.replace("split", "#");
		realdnis =realdnis.replace("split", "#");
		Usagelog=Usagelog.replace("split", "#");

		 if(contentlog.endsWith("#"))
               {
