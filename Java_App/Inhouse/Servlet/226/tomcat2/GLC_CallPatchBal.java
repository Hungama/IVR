 ...
 public class GLC_CallPatchBal extends HttpServlet
 {
     ...
     throws ServletException, IOException
   		{
     			...
     			String str2 = paramHttpServletRequest.getParameter("call_duration");
     			String str3 = paramHttpServletRequest.getParameter("call_flag");
     			...
     			try
     			{
     				  localConnection1 = ds.getConnection();
       				  if (localConnection1 != null)
       					{
       						  	localCallableStatement1 = localConnection1.prepareCall("{call hul_hungama.CALLPATCH_DURATION(?,?,?,?)}");
