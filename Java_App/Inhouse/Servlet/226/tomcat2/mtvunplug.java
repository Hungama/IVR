 ...
 */
public class mtvunplug extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
						...
						File file_txt1 = new File(getServletContext().getRealPath("config/mtvconfig/mtvunplug/artist_check.cfg"));
						//File file_txt1 = new File("C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/ROOT/hungama/config/artist_check.cfg");
