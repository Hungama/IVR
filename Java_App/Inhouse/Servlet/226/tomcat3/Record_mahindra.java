...
public class Record_mahindra extends HttpServlet
{

    public Record_mahindra()
    {
    }
        ...
        throws ServletException
    {
        ...
        uploadPath1 = new File((new StringBuilder("/tomcat3/webapps/hungama/RecordFiles/Mahindra/")).append(strDirectory).toString());
