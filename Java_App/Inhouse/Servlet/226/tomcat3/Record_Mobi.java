...
public class Record_Mobi extends HttpServlet
{
        ...
        throws ServletException
    {
        ...
        uploadPath1 = new File((new StringBuilder("/tomcat3/webapps/hungama/RecordFiles/Mobisur/")).append(strDirectory).toString());
