...
public class Record_lifestyle extends HttpServlet
{

    public Record_lifestyle()
    {
    }
        ...
        throws ServletException
    {
        ...
        uploadPath1 = new File((new StringBuilder("/tomcat3/webapps/hungama/RecordFiles/LIFESTYLE/")).append(strDirectory).toString());
