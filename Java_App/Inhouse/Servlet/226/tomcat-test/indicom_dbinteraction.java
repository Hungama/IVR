...
public class indicom_dbinteraction extends HttpServlet {
		...
		public void init() {
			try {
				...
				ds = (DataSource) envCtx.lookup("jdbc/indicom_jyotish");
			} catch (Exception e) {
		...
		protected void processRequest(HttpServletRequest request,
			...
			String data_base="indicom_jyotish";
			...
			String CALL =data_base+"."+PROCEDURE+"(";
