 ...
 */
public class appendcontent extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String CONDATA=request.getParameter("contentlog");
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/tmpcontentlog");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				outp = new FileOutputStream("/home/Hungama_call_logs/tmpcontentlog/"+ANI+".tmp", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/tmpcontentlog/"+ANI+".tmp", true);
