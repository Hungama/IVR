...
public class hungama_mtv_billing extends HttpServlet {
	...
	public void init() {
		try {
			...
			ds = (DataSource) envCtx.lookup("jdbc/hungama_mtv_docomo");
		} catch (Exception e) {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String value = null;
		String usr_status=null,balance=null,tarrif=null,mode_sub=null,FreeSub_Flag=null,top_dmin=null,lang=null,lang_status=null,planid=null;
		...
		try {
			...
			if (conat != null) {
				...
				{
					ccstmt = conat.prepareCall("{call MTV_QUERY(?,?,?,?)}");						
