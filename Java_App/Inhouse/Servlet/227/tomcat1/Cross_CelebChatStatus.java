...
/*     */
/*     */ public class Cross_CelebChatStatus extends HttpServlet
/*     */ {
...
/*     */
/*  49 */       ds = (DataSource)envCtx.lookup("jdbc/newseleb_hungama_cross");
/*     */     } catch (Exception e) {
...
/*  68 */     String IN_FLAG = request.getParameter("flag");
/*  69 */	  String IN_SERVER_IP = request.getParameter("in_server_ip");
...
/*  82 */           ccstmt1 = conat1.prepareCall("{call CELEB_STATUS(?,?,?,?,?,?)}");
/*  83 */         ccstmt1.setString(1, ANI);
			      ccstmt1.setString(2, "1");
/*  87 */         ccstmt1.setString(3, status);
				  ccstmt1.setString(4, IN_FLAG);
				  ccstmt1.setString(5, IN_SERVER_IP);
/*  88 */
/*  89 */
/*  90 */         ccstmt1.execute();
/*  91 */         conat1.close();
...
/*     */     }
/*     */
/* 118 */     String PROCEDURE = "CELEB_STATUS";
/* 119 */     if ("MTSM".equalsIgnoreCase(OPERATOR))
/* 120 */       PROCEDURE = "CELEB_STATUS";
/* 121 */     else if (("RELM".equalsIgnoreCase(OPERATOR)) || ("RELC".equalsIgnoreCase(OPERATOR)))
/* 122 */       PROCEDURE = "reliance_hungama.CELEB_STATUS";
/*     */     else
/* 124 */       PROCEDURE = "indicom_radio.CELEB_STATUS";
 ...
 * Qualified Name:     CelebChatStatus
