		...
		try {
			...
			synchronized(this)
			{
				try
				{
					...
					if(operator.equalsIgnoreCase("unim"))
						stmtupdate.executeUpdate("insert into master_db.tbl_consent_log_unim (ANI,circle,service,SC,firstconsent,firstconsenttime,secondconsent,secondconsenttime,ccgresult,IVRtransid,date_time,dtmf)values('"+ANI+"','"+circle+"','"+service+"','"+SC+"','"+firstconsent+"','"+firstconsenttime+"','"+secondconsent+"','"+secondconsenttime+"','"+ccgresult+"','"+IVRtransid+"',now(),'"+dtmf+"')");
					else
						stmtupdate.executeUpdate("insert into master_db.tbl_consent_log_tata (ANI,circle,service,SC,firstconsent,firstconsenttime,secondconsent,secondconsenttime,ccgresult,IVRtransid,date_time)values('"+ANI+"','"+circle+"','"+service+"','"+SC+"','"+firstconsent+"','"+firstconsenttime+"','"+secondconsent+"','"+secondconsenttime+"','"+ccgresult+"','"+IVRtransid+"',now())");
