 ...
 */
public class Uninor_DClog extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
        ...
        String realdnis = request.getParameter("realdnis");
         ...
         String ccgdtmf = request.getParameter("ccgdtmf");
		...
		try {
			...
			temp1 = "#"+service+"#" +ANI + "#" + circle + "#" + starttime + "#" + dnis + "#" + realdnis + "#"+ourtransid+"#"+ccgresult+"#"+ccgdtmf;

			FileOutputStream outp = null; // declare a file output object
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/DoubleConsentLog/UNINOR/"+service+"/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				strlogfile = service+"_switchlog_"+strlogfile;
				outp = new FileOutputStream("/home/Hungama_call_logs/DoubleConsentLog/UNINOR/"+service+"/" +strlogfile+".txt", true);
			}
			else
			{
				strlogfile = service+"_switchlog_"+strlogfile;
