...
public class tatc_mnd_dbinteraction extends HttpServlet
{
  private static final long serialVersionUID = 1L;
  static DataSource ds;
  static Logger log = Logger.getLogger(tatc_mnd_dbinteraction.class.getName());
  ...
  public void init()
  {
    try
    {
      ...
      ds = (DataSource)envCtx.lookup("jdbc/indicom_mnd");
    ...
    throws ServletException, IOException
  {
    ...
    log.info("INTOKEN IS : " + Inparameter_string);
    log.info("OUTTOKEN IS : " + Outparameter_string);
