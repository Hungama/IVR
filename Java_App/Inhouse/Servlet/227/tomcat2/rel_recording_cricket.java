...
public class rel_recording_cricket extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      Object localObject1 = ""; Object localObject2 = ""; Object localObject3 = ""; Object localObject4 = "";Object localObject5 = ""; String str1 = ""; String str2 = ""; String str3 = ""; String str4 = "";
      ...
      int i = 0;
       ...
       while ((localPart = localMultipartParser.readNextPart()) != null)
       {
         ...
         if (localPart.isParam())
         {
           ...
           if (str5.equalsIgnoreCase("req"))
             localObject1 = str1;
              if (str5.equalsIgnoreCase("ani"))
             localObject2 = str1;
              if (str5.equalsIgnoreCase("dni"))
             localObject3 = str1;
              if (str5.equalsIgnoreCase("lang"))
             localObject4 = str1;
              if (str5.equalsIgnoreCase("datetime"))
             localObject5 = str1;
           if (str5.equalsIgnoreCase("UploadFileName"))
             str3 = str1;
          this.uploadPath2= new File("/tomcat2/webapps/hungama/promptFiles/cricket/record/recordshare/");

           if (!this.uploadPath2.exists())
           		{
				    this.uploadPath1.mkdir();
				    this.uploadPath1 = new File("/tomcat2/webapps/hungama/promptFiles/cricket/record/recordshare/");
