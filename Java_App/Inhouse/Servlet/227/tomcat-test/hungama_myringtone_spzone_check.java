 ...
 */
public class hungama_myringtone_spzone_check extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			    ...
			    File file_txt1 = new File(getServletContext().getRealPath("unimodconfig/myringtone/"+circle + "/"+sp_file+".cfg"));
