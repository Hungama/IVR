...
import java.sql.*;
	...
	public class Etisalat_Bulkload_Process extends Thread
	{
	...
	public Etisalat_Bulkload_Process()
	{
		try
		{
			readDBCONFIG();
	...
	public void ETIBulkLoad(String filepath)
	{
		try
		{
	...
	public void run()
	{
		try{
				...
				ETIBulkLoad("/home/MISDATA_TEST/BILLINGDATA/ETISALAT/ETISALAT_"+ FILEDATE + ".txt");
			...
			public static void main(String arg[])
			{
				if(arg.length>0)
					...
					day = 1;
				Etisalat_Bulkload_Process c = new Etisalat_Bulkload_Process();
				c.start();
