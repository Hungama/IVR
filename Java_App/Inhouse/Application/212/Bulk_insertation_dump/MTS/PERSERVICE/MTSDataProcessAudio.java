...
import java.sql.*;
	...
	public class MTSDataProcessAudio extends Thread
	{
...
//						System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
				...
				System.out.println("***********MTS MU AUDIO CINEMA SUCCESS TABLE DATA INSERTING AT DESTINATION***********");
				while(Rsdnis.next())
				{
					try
					{
				...
				System.out.println("***********MTS MU AUDIO CINEMA FAILURE TABLE DATA INSERTING AT DESTINATION***********");
				while(Rs2dnis.next())
				{
					try
					{
				...
				System.out.println("***********MTS MU AUDIO CINEMA UNSUB TABLE DATA INSERTING AT DESTINATION***********");
				while(Rs3dnis.next())
				{
					try
					{
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		MTSDataProcessAudio c = new MTSDataProcessAudio();
		c.start();
