...
import java.sql.*;
	...
	public class MTS_Bulkload_Process_Contest extends Thread
	{
	...
	public MTS_Bulkload_Process_Contest()
	{
		try
		{
			readDBCONFIG();
		...
		try{
			...
			public static void main(String arg[])
			{
				if(arg.length>0)
					...
					day = 1;
				MTS_Bulkload_Process_Contest c = new MTS_Bulkload_Process_Contest();
				c.start();
