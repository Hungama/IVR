...
import java.sql.*;
	...
	public class Airtel_Bulkload_Process extends Thread
	{
	...
	public Airtel_Bulkload_Process()
	{
		try
		{
			readDBCONFIG();
	...
	public void Vh1BulkLoad(String filepath)
	{
		try
		{
				String str1 = "select count(1) as CNT from tbl_billing_vh1 nolock where DATE1 = date(subdate(now(),"+day+")) and service='VH1Airtel'";
				...
				if (localResultSet1.next())
				{
					...
					if (i >= 1)
					{
					  ...
					  stmt_destination.executeUpdate("delete from tbl_billing_vh1 where DATE1 = date(subdate(now(),"+day+")) and service='VH1Airtel'");
					}
					else
					{
	...
	public void GudLifeBulkLoad(String filepath)
	{
		try
		{
				String str2 = "select count(1) as CNT from tbl_billing_gl_airtel nolock where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet2.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_gl_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void BulkLoad54646(String filepath)
	{
		try
		{
				String str3 = "select count(1) as CNT from tbl_billing_54646_airtel where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet3.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_54646_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void RIABulkLoad(String filepath)
	{
		try
		{
	            String str4 = "select count(1) as CNT from tbl_billing_ria_airtel where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet4.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_ria_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void MTVBulkLoad(String filepath)
	{
		try
		{
				String str5 = "select count(1) as CNT from tbl_billing_mtv where DATE1 = date(subdate(now()," + day + ")) and service='MTVAirtel'";
				...
				if (localResultSet5.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mtv where DATE1 = date(subdate(now()," + day + ")) and service='MTVAirtel'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void PDBulkLoad(String filepath)
	{
		try
		{
				String str6 = "select count(1) as CNT from tbl_billing_pd_airtel where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet6.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_pd_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void MNDBulkLoad(String filepath)
	{
		try
		{
	            String str7 = "select count(1) as CNT from tbl_billing_mnd_airtel where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet7.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mnd_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void ComedyBulkLoad(String filepath)
	{
		try
		{
	            String str8 = "select count(1) as CNT from tbl_billing_comedy where DATE1 = date(subdate(now()," + day + ")) and service in('AirtelComedy','AirtelRegKK','AirtelRegTN','AirtelRegKR')";
				...
				if (localResultSet8.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_comedy where DATE1 = date(subdate(now()," + day + ")) and service in('AirtelComedy','AirtelRegKK','AirtelRegTN','AirtelRegKR')");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void DevoBulkLoad(String filepath)
	{
		try
		{
				String str9 = "select count(1) as CNT from tbl_billing_devo_airtel where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet9.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_devo_airtel where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void EnglishBulkLoad(String filepath)
	{
		try
		{
	            String str10 = "select count(1) as CNT from tbl_billing_se_airtel where DATE1 = date(subdate(now(),"+day+"))";
				...
				if(localResultSet10.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_se_airtel where DATE1 = date(subdate(now(),"+day+"))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void MUBulkLoad(String filepath)
	{
		try
		{
	            String str11 = "select count(1) as CNT from tbl_billing_mu_airtel where DATE1 = date(subdate(now(),"+day+"))";
				...
				if(localResultSet11.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mu_airtel where DATE1 = date(subdate(now(),"+day+"))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void PKBulkLoad(String filepath)
	{
		try
		{
	            String str12 = "select count(1) as CNT from tbl_billing_pk where DATE1 = date(subdate(now(),"+day+")) and service='AirtelPK'";
				...
				if(localResultSet12.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_pk where DATE1 = date(subdate(now(),"+day+")) and service='AirtelPK'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	...
	public void MNDKKBulkLoad(String filepath)
	{
		try
		{
	     		String str16 = "select count(1) as CNT from tbl_billing_mnd_airtelkk where DATE1 = date(subdate(now(),"+day+"))";
				...
				if(localResultSet16.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mnd_airtelkk where DATE1 = date(subdate(now(),"+day+"))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
		...
		try{
			...
			public static void main(String arg[])
			{
				if(arg.length>0)
					...
					day = 1;
				Airtel_Bulkload_Process c = new Airtel_Bulkload_Process();
				c.start();
