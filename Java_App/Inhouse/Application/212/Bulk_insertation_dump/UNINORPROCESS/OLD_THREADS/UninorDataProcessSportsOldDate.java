...
import java.sql.*;
	...
	public class UninorDataProcessSportsOldDate extends Thread
	{
	...
	public UninorDataProcessSportsOldDate()
	{
		try
		{
			readDBCONFIG();
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		UninorDataProcessSportsOldDate c = new UninorDataProcessSportsOldDate();
		c.start();
