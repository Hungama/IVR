...
import java.sql.*;
	public class UninorDataProcessOldDate extends Thread
	{
	...
	public UninorDataProcessOldDate()
	{
		try
		{
			readDBCONFIG();
	...
	public void run()
	{
		try{
				...
				String str1 = "select count(1) as CNT from tbl_billing_astro_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet1.next())
				{
					...
					if (i >= 1)
					{
					  ...
					  stmt_destination.executeUpdate("delete from tbl_billing_astro_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
	            ...
	            String str2 = "select count(1) as CNT from tbl_billing_54646_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet2.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_54646_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str3 = "select count(1) as CNT from tbl_billing_rt_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet3.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_rt_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str4 = "select count(1) as CNT from tbl_billing_aa_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet4.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_aa_uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str5 = "select count(1) as CNT from tbl_billing_redfm where date(Date) = date(subdate(now()," + day + ")) and service in('RedFMUninor','WAPREDFMUninor') and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet5.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_redfm where date(Date) = date(subdate(now()," + day + ")) and service in('RedFMUninor','WAPREDFMUninor') and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str6 = "select count(1) as CNT from tbl_billing_ria where date(Date) = date(subdate(now()," + day + ")) and service='RiaUninor' and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet6.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_ria where date(Date) = date(subdate(now()," + day + ")) and service='RiaUninor' and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str7 = "select count(1) as CNT from tbl_billing_mtv where date(Date) = date(subdate(now()," + day + ")) and service='MTVUninor' and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet7.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mtv where date(Date) = date(subdate(now()," + day + ")) and service='MTVUninor' and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
				...
				while(Rs19dnis.next())
				{
					try
					{
						...
						DATE1 = Rs19dnis.getString("date(date_time)");
						TIME1 = Rs19dnis.getString("time(date_time)");
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
				...
				while(Rs20dnis.next())
				{
					try
					{
						...
						DATE1 = Rs20dnis.getString("date(date_time)");
						TIME1 = Rs20dnis.getString("time(date_time)");
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
						stmt_destination.executeUpdate("insert into tbl_billing_mtv values('"+MSISDN+"','"+MODE+"','"+CHARGINGAMOUNT+"','"+CIRCLE+"','"+CHARGINGREASON+"','"+DATE+"','"+TYPE+"','"+USER_TYPE+"','"+SERVICE+"','"+DATE1+"','"+TIME1+"')");
					}
					catch(Exception e)
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str8 = "select count(1) as CNT from tbl_billing_cri_Uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet8.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_cri_Uninor where date(Date) = date(subdate(now()," + day + ")) and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str9 = "select count(1) as CNT from tbl_billing_comedy where date(Date) = date(subdate(now()," + day + ")) and service='UninorComedy' and `CHARGING REASON`='SUCCESS'";
				...
				if (localResultSet9.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_comedy where date(Date) = date(subdate(now()," + day + ")) and service='UninorComedy' and `CHARGING REASON`='SUCCESS'");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
				...
				stmt_destination.executeUpdate("update tbl_billing_54646_tatadocomo set mode='IVR' where mode REGEXP '^-?[0-9]+$' and date(Date) = date(subdate(now()," + day + "))");
				stmt_destination.executeUpdate("update tbl_billing_54646_tatadocomo set `CHARGING REASON`='33' where  `CHARGING REASON` is NULL or`CHARGING REASON`='NA' and date(Date) = date(subdate(now()," + day + "))");
				stmt_destination.executeUpdate("update tbl_billing_54646_tatadocomo set `USER TYPE`='NA' where ( `USER TYPE` in ('0','/N','NULL','') or `USER TYPE` is NULL) and date(Date) = date(subdate(now()," + day + "))");
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		UninorDataProcessOldDate c = new UninorDataProcessOldDate();
		c.start();
