...
public class HitUrlHul
{
	...
	public String hitUrl()
	{
		...
		try{
			...
			urlString="http://121.241.247.190:7501/failsafe/HttpLink?aid=428262&pin=HVOU1&signature=GLCONE&mnumber="+getAni()+"&message="+URLEncoder.encode(getMessage(),"UTF-8");

			System.out.println("URL to Hit from HUL -" +urlString);
	...
	public void log(String response)
	{
		try
		{
			...
			ps.close();
			fos.close();
			System.out.println(mystrdate+"#"+mystrtime+"#"+response+"#"+getAni()+"#"+getDate_time()+"#"+getDnis()+"#"+getFlag()+"#"+getMessage()+"#"+getStatus()+"# from HUL");
		}
		catch(Exception e)
		{
