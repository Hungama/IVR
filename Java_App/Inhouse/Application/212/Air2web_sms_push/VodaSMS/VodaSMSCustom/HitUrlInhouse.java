...
public class HitUrlInhouse 
{
	...
	public String hitUrl()
	{
		...
		System.out.println("URL to Hit from Inhouse -" +urlString);
	...
	public void log(String response)
	{
		try
		{
			...
			ps.close();
			fos.close();			
			System.out.println(mystrdate+"#"+mystrtime+"#"+response+"#"+getAni()+"#"+getDate_time()+"#"+getDnis()+"#"+getFlag()+"#"+getMessage()+"#"+getStatus()+"# from Inhouse");
		}
		catch(Exception e)
		{
