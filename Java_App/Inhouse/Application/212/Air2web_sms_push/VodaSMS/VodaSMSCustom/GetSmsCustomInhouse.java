...
public class GetSmsCustomInhouse implements Runnable
{
	...
	public void createConnect() 
	{
		try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://192.168.100.224/master_db", "ivr", "ivr");
	...
	public static void main(String[] args) 
	{
		...
		GetSmsCustomInhouse ob=new GetSmsCustomInhouse();
		ob.run();
