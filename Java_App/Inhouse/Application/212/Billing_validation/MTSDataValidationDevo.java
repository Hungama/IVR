...
public class MTSDataValidationDevo extends Thread
{
	...
	{
		MTSDataValidationDevo validation = new MTSDataValidationDevo();
		validation.start();
	}
	...
	public int MtsMuValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_mu_mts nolock where date(Date) = date(subdate(now()," + day + "))";
	            ...
	            String str4 = "select count(1) as CNT4 from mts_radio.tbl_radio_unsub nolock where date(unsub_date) = date(subdate(now(),"+day+"))";
	...
	public int MTS54646Validation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_54646_mts nolock where date(Date) = date(subdate(now()," + day + "))";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int RedfmValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from Tbl_billing_RedFM nolock where date(Date) = date(subdate(now()," + day + ")) and service='RedFMMTS'";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int MtvValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from Tbl_billing_MTV nolock where date(Date) = date(subdate(now()," + day + ")) and service='MTVMTS'";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int DevoValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_devo_mts nolock where date(Date) = date(subdate(now()," + day + "))";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int CelebValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_fmj_mts nolock where date(Date) = date(subdate(now()," + day + "))";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int VAValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_vs_mts nolock where date(Date) = date(subdate(now()," + day + "))";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
	...
	public int MNDValidation()
	{
		try
		{
				String str1 = "select count(1) as CNT1 from tbl_billing_mnd_mts nolock where date(Date) = date(subdate(now()," + day + "))";
				ResultSet localResultSet1 = stmt_destination.executeQuery(str1);
				if(localResultSet1.next())
				{
					cnt1 = localResultSet1.getInt("CNT1");
