...
import java.sql.*;
	...
	public class DocomoArtistAloudMis218 extends Thread
	{
	...
	public DocomoArtistAloudMis218()
	{
		try
		{
			readDBCONFIG();
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		DocomoArtistAloudMis218 c = new DocomoArtistAloudMis218();
		c.start();
	}
	public void run()
	{
		try
		{
				...
				while(Rsdate.next())
				{
					...
					System.out.println("****Running AATataDoCoMoloud for date :****"+FileDate);
				}
				int SERVICEID = 0;
				int PLANID = 0;
				if(day>2)
				...
				String str1 = "select count(1) as CNT from dailymis where Date = date(subdate(now(),"+day+")) and Service='AATataDoCoMo'";
				...
				if (localResultSet1.next())
				{
					...
					if (i >= 1)
					{
					  ...
					  stmt_destination.executeUpdate("delete from dailymis where Date = date(subdate(now(),"+day+")) and Service='AATataDoCoMo'");
					}
					else
					{
				...
				while(Rs2dnis.next())
				{
					try
					{
	                   ...
	                   // System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	                    //System.out.println("insert into dailymis2(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+EVENT_TYPE+"','"+CIRCLE+"','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
						stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+EVENT_TYPE+"','"+CNT+"','"+CHARGAMT+"')");
					}
					catch(Exception e)
					{
				...
				while(Rs3dnis.next())
				{
				   ...
				   // System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
				   	System.out.println("insert into dailymis(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+MODE_TYPE+"','"+CIRCLE+"','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+MODE_TYPE+"','"+CIRCLE+"','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+EVENT_TYPE+"','"+CNT+"','0.00')");
				}
				/////////////////////////////////// pending Base ////////////////////////////////////////////////////////////
				...
				while(Rs4dnis.next())
				{
					...
					CIRCLE = getCIRCLE(CIRCLE);
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Pending_Base','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','Pending_Base,'"+CNT+"','0.00')");
				}
				////////////////////////////////////////////////////// Active Base ///////////////////////////////////////////////////////////////
				...
				while(Rs5dnis.next())
				{
					...
					CIRCLE = getCIRCLE(CIRCLE);
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Active_Base','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','Active_Base','"+CNT+"')");
				}
				//////////////////////////////////////////////////// Deactivation //////////////////////////////////////////////////
				...
				while(Rs6dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Deactivation_30','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','Deactivation_30','"+CNT+"')");
				}
				////////////////////////////////////////////// Mode_Deactivation /////////////////////////////////////////////////////////////////////////////
				...
				while(Rs7dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+deactivation_str1+"','"+CIRCLE+"',0,'"+CNT+"','"+UNSUB_REASON+"','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+deactivation_str1+"','"+CNT+"','0.00')");
				}
				///////////////////////////////////////////////////////////// CALL_TF //////////////////////////////////////////////////////////////////////
				...
				while(Rs8dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','CALLS_TF','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','CALLS_TF','"+CNT+"','0.00')");
				}
				...
				while(Rs9dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+call_TF+"','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+call_TF+"','"+CNT+"','0.00')");
				}
				/////////////////////////////////////////////////////////////// MOU_TF //////////////////////////////////////////////////////////////////////////
				...
				while(Rs10dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','MOU_TF','"+CIRCLE+"',0,'"+MOUS+"','NA','"+MOUS+"','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','MOU_TF','"+MOUS+"','0.00')");
				}
				////////////////////////////////////////////////////////////////MOU LIVE NON LIVE
				...
				while(Rs11dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+Mous_TF+"','"+CIRCLE+"',0,'"+MOUS+"','NA','"+MOUS+"','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+Mous_TF+"','"+MOUS+"','0.00')");
				}
				////////////////////////////////////////////////////////////////PULSE LIVE NON LIVE
				...
				while(Rs12dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','PULSE_TF','"+CIRCLE+"',0,'"+PULSE+"','NA','NA','"+PULSE+"','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','PULSE_TF','"+PULSE+"','0.00')");
				}//END
				...
				while(Rs14dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','UU_TF','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','UU_TF','"+CNT+"','0.00')");
				}//END
				...
				while(Rs15dnis.next())
				{
					...
					if(USER_STATUS.equals("Active"))
							...
							UU_TF_TYPE="N_UU_TF";
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+UU_TF_TYPE+"','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+UU_TF_TYPE+"','"+CNT+"','0.00')");
				}//END
				//////////////////////////////////////////////////////// SEC_TF
				...
				while(Rs16dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','SEC_TF','"+CIRCLE+"',0,'"+DURATION+"','NA','NA','NA','"+DURATION+"','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','SEC_TF','"+DURATION+"','0.00')");
				}//END
				...
				while(Rs17dnis.next())
				{
					...
					//stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+SEC_TF_TYPE+"','"+CIRCLE+"',0,'"+DURATION+"','NA','NA','NA','"+DURATION+"','1002')");
					stmt_destination.executeUpdate("insert into dailymis(Date,Service,Circle,Type,Value,Revenue) values('"+FileDate+"','AATataDoCoMo','"+CIRCLE+"','"+SEC_TF_TYPE+"','"+DURATION+"','0.00')");
				}//END
				...
				while(Rs18dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into dailymis2(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+FAIL_EVENT_TYPE+"','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA','1002')");
				}*/
		}
		catch(Exception e)
		{
