...
import java.sql.*;
	...
	public class TuneTalkMis extends Thread
	{
	...
	public void run()
	{
		try
		{
				...
				while(Rsdate.next())
				{
					...
					System.out.println("****Running TuneTalkMis for date :****"+FileDate);
				}
				int SERVICEID = 0;
				int PLANID = 0;
				/*if(day>2)
				...
				*/
				...
				String str1 = "select count(1) as CNT from mis_db.tbl_daily_report_test where date(report_date) = date(subdate(now(),"+day+"))";
				...
				if (localResultSet1.next())
				{
					...
					if (i >= 1)
					{
					  ...
					  stmt_destination.executeUpdate("delete from mis_db.tbl_daily_report_test where date(report_date) = date(subdate(now(),"+day+"))");
					}
					else
					{
	            ...
	            String Activation_Query = "select count(msisdn) as cnt,chrg_amount,service_id,event_type from "+ BillingTable +" nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id in(1901) and event_type in('SUB','RESUB','TOPUP') group by chrg_amount,service_id,event_type";
	            //get_activation_query="select count(msisdn) as cnt,circle,chrg_amount,service_id,event_type from master_db.tbl_billing_success nolock where DATE(response_time)='$view_date1' and service_id in(1901) and event_type in('SUB') group by service_id,chrg_amount,event_type";
				...
				while(Rs2dnis.next())
				{
					try
					{
	                   ...
	                   // System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	                    //System.out.println("insert into mis_db.tbl_daily_report_test(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+EVENT_TYPE+"','"+CIRCLE+"','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
						stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+EVENT_TYPE+"','Indian','"+SERVICEID+"','"+CHARGAMT1+"','"+CNT+"','NA','NA','NA')");
					}
					catch(Exception e)
					{
				...
				while(Rs3dnis.next())
				{
				   ...
				   // System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
				   	//System.out.println("insert into mis_db.tbl_daily_report_test(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+MODE_TYPE+"','"+CIRCLE+"','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,service_id,charging_rate,total_count,mous,pulse,total_sec) values('"+FileDate+"','"+MODE_TYPE+"','Indian','"+SERVICEID+"','"+CHARGAMT+"','"+CNT+"','NA','NA','NA')");
				}
				/////////////////////////////////// pending Base ////////////////////////////////////////////////////////////
				...
				if(Rs4dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Pending_Base','Indian',0,'"+CNT+"','NA','NA','NA','1901')");
				}
				////////////////////////////////////////////////////// Active Base ///////////////////////////////////////////////////////////////
				...
				stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Active_Base','Indian',0,'"+BaseCnt3+"','NA','NA','NA','1901')");
				//////////////////////////////////////////////////// Deactivation //////////////////////////////////////////////////
				...
				if(Rs6dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mous,pulse,total_sec,service_id) values('"+FileDate+"','Deactivation_2','Indian',0,'"+CNT+"','NA','NA','NA','1901')");
				}
				////////////////////////////////////////////// Mode_Deactivation /////////////////////////////////////////////////////////////////////////////
				...
				while(Rs7dnis.next())
				{
					...
					if(UNSUB_REASON == "SELF_REQS" || UNSUB_REASON == "SELF_REQ") UNSUB_REASON ="IVR";
					deactivation_str1="Mode_Deactivation_"+UNSUB_REASON;

					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+deactivation_str1+"','Indian',0,'"+CNT+"','"+UNSUB_REASON+"','NA','NA','NA','1901')");
				}
				///////////////////////////////////////////////////////////// CALL_TF //////////////////////////////////////////////////////////////////////
				...
				if(Rs8dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','CALLS_TF','Indian',0,'"+CNT+"','NA','NA','NA','NA','1901')");
				}
				...
				while(Rs9dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+call_TF+"','Indian',0,'"+CNT+"','NA','NA','NA','NA','1901')");
				}
				/////////////////////////////////////////////////////////////// MOU_TF //////////////////////////////////////////////////////////////////////////
				...
				if(Rs10dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','MOU_TF','Indian',0,'"+MOUS+"','NA','"+MOUS+"','NA','NA','1901')");
				}
				////////////////////////////////////////////////////////////////MOU LIVE NON LIVE
				...
				while(Rs11dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+Mous_TF+"','Indian',0,'"+MOUS+"','NA','"+MOUS+"','NA','NA','1901')");
				}
				////////////////////////////////////////////////////////////////PULSE LIVE NON LIVE
				...
				if(Rs12dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','PULSE_TF','Indian',0,'"+PULSE+"','NA','NA','"+PULSE+"','NA','1901')");
				}//END
				...
				if(Rs14dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','UU_TF','Indian',0,'"+CNT+"','NA','NA','NA','NA','1901')");
				}//END
				...
				while(Rs15dnis.next())
				{
					...
					if(USER_STATUS.equals("Active"))
							...
							UU_TF_TYPE="N_UU_TF";
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+UU_TF_TYPE+"','Indian',0,'"+CNT+"','NA','NA','NA','NA','1901')");
				}//END
				//////////////////////////////////////////////////////// SEC_TF
				...
				if(Rs16dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','SEC_TF','Indian',0,'"+DURATION+"','NA','NA','NA','"+DURATION+"','1901')");
				}//END
				...
				while(Rs17dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+SEC_TF_TYPE+"','Indian',0,'"+DURATION+"','NA','NA','NA','"+DURATION+"','1901')");
				}//END
				...
				while(Rs18dnis.next())
				{
					...
					stmt_destination.executeUpdate("insert into mis_db.tbl_daily_report_test(report_date,type,circle,charging_rate,total_count,mode_of_sub,mous,pulse,total_sec,service_id) values('"+FileDate+"','"+FAIL_EVENT_TYPE+"','"+CIRCLE+"',0,'"+CNT+"','NA','NA','NA','NA',1513)");
				}*/
		}
		catch(Exception e)
		{
