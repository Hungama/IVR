...
import java.sql.*;
	...
	public void run()
	{
		try{
	            ...
	            String str4 = "select count(1) as CNT from tbl_billing_redfm_tatadocomocdma where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet4.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_redfm_tatadocomocdma where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	            ...
	            String str5 = "select count(1) as CNT from tbl_billing_ria_tatadocomocdma where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet5.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_ria_tatadocomocdma where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
