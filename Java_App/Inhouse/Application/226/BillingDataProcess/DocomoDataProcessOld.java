...
import java.sql.*;
	...
	public class DocomoDataProcessOld extends Thread
	{
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		DocomoDataProcessOld c = new DocomoDataProcessOld();
		c.start();
