...
import java.sql.*;
	...
	public class UninorDataProcessSMS extends Thread
	{
	...
	public void run()
	{
		try{
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String Ring_Failure = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE','EVENT' as 'TYPE',case plan_id when '69' then 'Polytunes' when '70' then 'Monotones' when '71' then 'TrueTones' else 'others' end 'USER_TYPE',plan_id 'SERVICE',date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1412";
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str5 = "select count(1) as CNT from tbl_billing_redfm_uninor where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet5.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_redfm_uninor where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str6 = "select count(1) as CNT from tbl_billing_ria_uninor where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet6.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_ria_uninor where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str7 = "select count(1) as CNT from tbl_billing_mtv_uninor where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet7.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_mtv_uninor where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String Contest_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE',plan_id 'SERVICE',date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1423";
			...
			//			System.out.println(MSISDN+","+MODE+","+CHARGINGAMOUNT+","+CIRCLE+","+CHARGINGREASON+","+DATE+","+TYPE+","+USER_TYPE+","+SERVICE+","+DATE1+","+TIME1);
	            ...
	            String str11 = "select count(1) as CNT from tbl_billing_va_uninor where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet11.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_va_uninor where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	            ...
	            String BollyAlerts_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','UninorVABollyAlerts' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1430";
	            ...
	            String FilmiWords_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','UninorVAFilmy' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1431";
	            ...
	            String FilmiHealth_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','UninorVAHealth' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1433";
	            ...
	            String CFashion_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','UninorVAFashion' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1434";
	            ...
	            String str12 = "select count(1) as CNT from tbl_billing_sms_uninor  where DATE1 = date(subdate(now()," + day + "))";
				...
				if (localResultSet12.next())
				{
					...
					{
					  System.out.println("****Deleting the records****");
					  stmt_destination.executeUpdate("delete from tbl_billing_sms_uninor  where DATE1 = date(subdate(now()," + day + "))");
					}
					else
					{
					   System.out.println("****No DB Records to Delete****");
	            ...
	            String SmsFashion_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','SMSUninorFashion' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1438";
	            ...
	            String SmsLocalGuj_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','SMSUninorGujarati' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1439";
	            ...
	            String SmsRichAlerts_fail = "select concat('91',msisdn) 'MSISDN',if(mode is null,'IVR',mode) 'MODE','0' as 'CHARGING AMOUNT',circle,status as 'CHARGING REASON',response_time 'DATE',case event_type when 'sub' then 'Activation' when 'TOPUP' then 'TOP-UP' when 'EVENT' then 'EVENT' when 'resub' then 'Renewal' else event_type end 'TYPE',cppp 'USER_TYPE','SMSUninorAlert' SERVICE,date(response_time),ccg_id from master_db.tbl_billing_failure nolock where date(response_time)=date(subdate(now(),"+day+")) and service_id=1440";
...
*/
	...
	public static void main(String arg[])
	{
		if(arg.length>0)
			...
			day = 1;
		UninorDataProcessSMS c = new UninorDataProcessSMS();
		c.start();
