 ...
 */
public class check_MOD_Promptfile extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			if (pname!= null) {
				...
				//File file_txt1 = new File("/tomcat2/webapps/hungama/promptFiles/mod/spzone/"+lang+"/"+pname);
				File file_txt1 = new File("file:/var/opt/OC/contentrepository/hungama/promptFiles/mod/spzone/"+lang+"/"+pname);
				//File file_txt1 = new File("file:/var/opt/OC/contentrepository/hungama/promptFiles/mod/spzone/01/spzone_kol_1905.wav");
				//File file_txt1 = new File("/var/lib/apache-tomcat-6.0.32/webapps/hungama/hungama_mod/spzoneprompts/"+lang+"/"+pname);
