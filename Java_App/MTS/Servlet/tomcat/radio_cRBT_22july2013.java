	...
	protected void processRequest(HttpServletRequest request,
		...
		try
		{
				...
				if(Token.equalsIgnoreCase("USERSTATUS"))
					...
					ulink ="http://10.130.7.35:80/interfaces/ordertone.do?operatoraccount=hungama&operatorpwd=hungama&phonenumber="+ANI+"&operator=18&userbrand=688&isuct=1";
				else if(Token.equalsIgnoreCase("DOWNLOAD"))
					ulink ="http://10.130.7.35:80/interfaces/ordertone.do?operatoraccount=hungama&operatorpwd=hungama&phonenumber="+ANI+"&resourcecode="+CLIPID+"&resourcetype=1&operator=18&isuct=1";
