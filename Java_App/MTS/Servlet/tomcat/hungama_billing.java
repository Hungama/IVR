...
public class hungama_billing extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String value = null,usrmoviename=null,usrmoviectr=null;
		String usr_status=null,balance=null,tarrif=null,mode_sub=null,FreeSub_Flag=null,top_dmin=null,lang=null,lang_status=null;
		String wl_status=null,PlayListCount=null,top_amount=null,operatorid=null,circleid=null,servicesid=null;
		int totaltop;
		...
		String moviectr = (String) request.getParameter("moviectr");
		String moviename = (String) request.getParameter("moviename");
		String Flag = (String) request.getParameter("Flag");
		top_amount=(String) request.getParameter("TOPUPAMTID");
		...
		try {
			...
			if (conat != null) {
				...
				}else if(TOKEN.equals("11")) // check user new or old  for Audio Cinema
				{
					ccstmt = conat.prepareCall("{call JBOX_QUERY(?,?,?)}");						
					ccstmt.setString(1,ANI );				
					ccstmt.setString(2,TOKEN);		
					...
					else // Existing User
					{
						...
						lang = "usrlang.value='" + temp[1].trim().toLowerCase() + "'";
						balance = "usrbalance.value='" + temp[2] + "'";	
						usrmoviectr = "usrmoviectr.value='" + temp[3] + "'";

						out.println(usr_status);
						out.println(lang);
						out.println(balance);
						out.println(usrmoviectr);
				...
				{					
					...
					ccstmt.setString(3, moviename);
					ccstmt.setString(4, moviectr);
