...
public class song_missing extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/missing_songs/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				outp = new FileOutputStream("/home/Hungama_call_logs/missing_songs/missing_songs_"+strlogfile+".txt", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/missing_songs/missing_songs_"+strlogfile+".txt", true);
