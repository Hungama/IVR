...
public class hungama_spzone_54646 extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String eventcheck = request.getParameter("checkstatus");
		...
		try {
			...
			if(eventcheck.equals("specialzone"))
			{
								c_time1=c_time1+1;
								...
								sp_file=type+"_spzone";
								 ...
								 File file_txt1 = new File(getServletContext().getRealPath("config/54646V2/mtsm/spzone/"+sp_file+".cfg"));
			...
			else
			{
							c_time1=c_time1+1;
								...
								//out.println(t_tday);
								sp_file=type+"_spzone";
								File file_txt1 = new File(getServletContext().getRealPath("config/54646V2/mtsm/spzoneeventcheck/"+sp_file+".cfg"));
								if(file_txt1.exists())
								{
									ArrayList data = new ArrayList();
									BufferedReader in = new BufferedReader(new FileReader(file_txt1));
								...
								if(hashMap.get(key)!=null)
								{
									...
									if(type.equals("sub"))
										...
										favSongs1 = "eventzone.value='"+ favSongs1 + "'";
									out.println(favSongs1);
									return;
								}
