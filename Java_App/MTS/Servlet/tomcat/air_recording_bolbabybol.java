      ...
      int i = 0;
       ...
       while ((localPart = localMultipartParser.readNextPart()) != null)
       {
         ...
         if (localPart.isParam())
         {
           ...
           this.uploadPath2= new File("/var/lib/LIVERECORDING/BOLBABYBOL/2012/"+(String)localObject2);

           if (!this.uploadPath2.exists())
           		{
				    this.uploadPath1.mkdir();
				    this.uploadPath1 = new File("/var/lib/LIVERECORDING/BOLBABYBOL/2012/" +(String)localObject2+"/"+ (String)localObject3);
