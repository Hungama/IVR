...
public class Record_bolbabybol extends HttpServlet
{

    public Record_bolbabybol()
    {
    }
        ...
        throws ServletException
    {
        ...
        uploadPath1 = new File((new StringBuilder("/var/lib/apache-tomcat-6.0.29/webapps/hungama/RecordFiles/BOLBABYBOL/")).append(strDirectory).toString());
        ...
        throws ServletException, IOException
    {
        ...
        System.out.println("my file name  is :" + (new StringBuilder()).append(uploadPath1).append("/").append(month).append("/").toString());
        recFile1 = new File((new StringBuilder()).append(uploadPath1).append("/").append(month).append("/").toString());
       /* if(!recFile.exists())
        {
        ...
        try
        {
			if(recFile1.exists())
			{
				System.out.println("folder found :");
				 recFile = new File((new StringBuilder()).append(uploadPath1).append("/").append(month).append("/").append(day).append("/").toString());
       			if(recFile.exists())
					{
					 String newFileName = (new StringBuilder()).append(uploadPath1).append("/").append(month).append("/").append(day).append("/").append(recFilename).toString();
