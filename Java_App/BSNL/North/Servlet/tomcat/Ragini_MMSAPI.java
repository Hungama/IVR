	...
	protected void processRequest(HttpServletRequest request,HttpServletResponse res) throws ServletException, IOException {
		...
		try
		{
				 ...
				 if(operator.equalsIgnoreCase("MTS"))
					...
					ulink="http://119.82.69.212/kmis/services/hungamacare/getWallpaperlink.php?ani="+MSISDN+"&op="+operator+"&circle="+circle;
...
System.out.println("*******************END***************************"+RES);
			...
			else
				{
					...
					try
					{
System.out.println("*******************END***************************"+MSISDN+"--"+RES+"--"+continous_counter);
