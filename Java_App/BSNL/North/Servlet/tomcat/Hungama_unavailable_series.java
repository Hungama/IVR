 ...
 */
public class Hungama_unavailable_series extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String msisdn = request.getParameter("ANI");
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/Series_unavailable/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				outp = new FileOutputStream("/home/Hungama_call_logs/Series_unavailable/no_series_"+strlogfile+".txt", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/Series_unavailable/no_series_"+strlogfile+".txt", true);
