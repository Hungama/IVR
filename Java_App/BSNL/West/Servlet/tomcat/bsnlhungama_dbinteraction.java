...
public class bsnlhungama_dbinteraction extends HttpServlet
{
 ...
 // static Logger log = Logger.getLogger(loophungama_dbinteraction.class.getName());
  ...
  public void init()
  {
    try
    {
      ...
      ds = (DataSource)localContext.lookup("jdbc/BSNL_hungama");
    ...
    throws ServletException, IOException
  {
	...
	System.out.println("INTOKEN:"+str1);
	System.out.println("INTOKEN:"+str2);
	System.out.println("OUTTOKEN:"+str3);
