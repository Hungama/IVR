...
public class BSNL_Concentlog extends HttpServlet {
	...
	static HashMap hashMap = new HashMap();
		...
		public static String pwd="billing456";
		...
		public void init()
		{
			try
			{
				...
				con = DriverManager.getConnection("jdbc:mysql://192.168.1.7/"+ dsn, username, pwd);
				if(con!=null)
		...
		try {
			...
			synchronized(this)
			{
				try
				{
					...
					p1.flush();
					p1.close();
					System.out.println("data insert in table ANI:- "+ANI+"    connection is "+con);
				...
				{
					System.out.println("outp is not opened"+E);
				}
			}
