      ...
      int i = 0;
       ...
       while ((localPart = localMultipartParser.readNextPart()) != null)
       {
         ...
         if (localPart.isParam())
         {
           ...
           this.uploadPath2= new File("/var/lib/apache-tomcat-6.0.32/webapps/hungama/Content/111/BOLBABYBOL/2012/"+(String)localObject2);

           if (!this.uploadPath2.exists())
           		{
				    this.uploadPath1.mkdir();
				    this.uploadPath1 = new File("/var/lib/apache-tomcat-6.0.32/webapps/hungama/Content/111/BOLBABYBOL//var/lib/apache-tomcat-6.0.32/webapps/hungama/Content/111/BOLBABYBOL/2012/" +(String)localObject2+"/"+ (String)localObject3);
		   		...
		   		{
					this.uploadPath1 = new File("/var/lib/apache-tomcat-6.0.32/webapps/hungama/Content/111/BOLBABYBOL//2012/" +(String)localObject2+"/"+ (String)localObject3);
					System.out.println("uploadPath :" + this.uploadPath1);
					if (!this.uploadPath1.exists())
						 this.uploadPath1.mkdir();
					else
