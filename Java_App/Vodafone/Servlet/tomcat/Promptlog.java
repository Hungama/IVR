 ...
 */
public class Promptlog extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		String promptlog = request.getParameter("promptlog");
		...
		try {
			...
			PrintStream p = null;
			File ServiceFolder = new File("/home/Hungama_call_logs/FKS_Promptslog/");
			if (!ServiceFolder.exists())
			{
				ServiceFolder.mkdir();
				outp = new FileOutputStream("/home/Hungama_call_logs/FKS_Promptslog/FKS_Promptlog_"+strlogfile+".txt", true);
			}
			else
			{
				outp = new FileOutputStream("/home/Hungama_call_logs/FKS_Promptslog/FKS_Promptlog_"+strlogfile+".txt", true);
