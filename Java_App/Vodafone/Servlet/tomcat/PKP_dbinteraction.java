...
public class PKP_dbinteraction extends HttpServlet
{
  private static final long serialVersionUID = 1L;
  static DataSource ds;
  static Logger log = Logger.getLogger(PKP_dbinteraction.class.getName());
  ...
  public void init()
  {
    try
    {
      ...
      ds = (DataSource)envCtx.lookup("jdbc/voda_PKP");
