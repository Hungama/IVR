...
import org.apache.log4j.Logger;
 ...
 public class vodmredfm_dbinteraction extends HttpServlet
 {
   private static final long serialVersionUID = 1L;
   static DataSource ds;
   static Logger log = Logger.getLogger(vodmredfm_dbinteraction.class.getName());
   ...
   public void init()
     {
       try
       {
         ...
         ds = (DataSource)envCtx.lookup("jdbc/vodafone_redfm");
     ...
     throws ServletException, IOException
   {
     ...
     try
     {
       ...
       if (conat != null)
       {
		 ...
		 log.error("Procedure called: " +CALL+ " Error is: " +e.toString());
       e.printStackTrace();
     } finally {
       out.close();
       out = null;
